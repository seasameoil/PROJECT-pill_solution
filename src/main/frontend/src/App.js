  ...
  return (
    ...
    <Card style={{ width: '30rem' }}>
      ...
      <Card.Body>
        ...
        <Card.Text>
          <b>치료법</b><br /> 
          이비인후과·신경과·정신건강의학과 등 여러 진료과의 협진이 
          가능한 병원을 찾아 원인을 찾고 정기적인 운동으로 체력을 보강하고 병원에서 상담하면서 심리적, 신체적 안정 필요하다<br />
        </Card.Text>
  ...
  return (
    <Card style={{ width: '30rem' }}>
      ...
      <Card.Body>
        ...
        <Card.Text>
          <b>치료법</b><br /> 
          긴장성 두통은 약을 사용하거나 정신 치료, 바이오 피드백, 
          이완 요법 등을 이용하여 치료 편두통은 어두운 방에서 안정된 분위기를 갖추고 푹 자게 하면 증세가 좋아집니다.
        </Card.Text>
  ...
  return (
    <Card style={{ width: '30rem' }}>
      ...
      <Card.Body>
        ...
        <Card.Text>
          <b>치료법</b> <br /> 
          식중독의 치료 원칙은 구토나 설사로 인한 체내 수분 손실과 전해질을 보급하는 데 있어
          수액 공급 등의 대증요법이 주요 치료 방향이 되며, 극히 일부의 경우 항생제의 사용이 고려된다.
          혈변이나 점액성변, 혹은 발열이 동반되거나 고령, 면역저하 환자의 경우는 항생제의 투여를 고려한다.<br />
        </Card.Text>
    ...
    <CardGroup>
      ...
      <Card>
        ...
        <Card.Body>
          ...
          <Card.Text>
            <b>복용방법</b><br />
            - 성인: 1회 1-2정 1일 3회 복용 / 식후 복용<br />
            <b>효과</b><br />
            - 소화불량, 식욕감퇴, 과식, 체함, 소화촉진, 소화불량으로 인한 위부팽만감 <br />
    ...
    <CardGroup>
      <Card>
        ...
        <Card.Body>
          ...
          <Card.Text>
            <b>복용방법</b><br />
            - 성인 1일 1포(3g) 1일 3회 <br />
            - 소아(24개월 이상) : 3일간 1일 6~9g 분할 복용, 이후 4일간은 하루 6g을 분할 복용<br />
            <b>효과</b><br />
            -성인의 위장관 질환에 의한 통증 완화제 <br />
      ...
      <Card>
        ...
        <Card.Body>
          ...
          <Card.Text>
            <b>복용방법</b><br />
            - 성인 : 1일 1포(3g) 1일 3회 / 공복에 복용 <br />
            - 소아(24개월 이상) : 3일간 1일 6~9g 분할 복용, 이후 4일간은 하루 6g을 분할 복용<br />
            <b>효과</b><br />
            - 성인의 식도, 위,십이지장과 관련된 통증의 완화 <br />
            - 성인의 급,만성 설사 <br />
    ...
    <CardGroup>
      <Card>
        ...
        <Card.Body>
          ...
          <Card.Text>
            <b>복용방법</b><br />
            - 15세 이상 : 1일 2정 1일 3회 복용 / 식후 복용 <br />
            <b>효과</b><br />
            - 두통, 치통, 발치 후 통증, 인후통, 귀의 통증, 관절통, 신경통,
            요(허리)통,근육통, 어깨통증, 타박통, 골절통, 생리통, 외상통의 진통<br />
            - 오한, 발열시의 해열
          </Card.Text>
        </Card.Body>
      ...
      <Card>
        ...
        <Card.Body>
          ...
          <Card.Text>
            <b>복용방법</b><br />
            - 15세 이상 : 1일 1정 1일 3회 복용 / 공복 시를 피하여 복용 / 복용간격은 4시간 이상으로 함 <br />
            - 15세 미만의 소아는 이 약을 복용하지 않는다.<br />
            <b>효과</b><br />
            - 다음 질환의 진통 및 해열 시 단기 치료 : 두통, 치통, 발치 후 통증, 인후통, 귀의 통증, 관절통, 신경통, 요(허리)통,
    ...
    <CardGroup>
      <Card>
        ...
        <Card.Body>
          ...
          <Card.Text>
            <b>복용방법</b><br />
            - 성인 : 1일 1정 1일 3회 복용<br />
            <b>효과</b><br />
            - 말초동맥 순환장애(간헐성 파행증) 치료 <br />
            - 어지러움, 혈관성 및 퇴행성 이명  <br />
            - 이명, 두통, 기억력 감퇴, 집중력 장애, 우울감, 어지러움 등의 치매성 증상을  
            수반하는 기질성 뇌기능장애의 치료
          </Card.Text>
        </Card.Body>
      ...
      <Card>
        ...
        <Card.Body>
          ...
          <Card.Text>
            <b>복용방법</b><br />
            - 아침-저녁 식후에 1캡슐식 복용<br />
            <b>효과</b><br />
            -말초동맥 순환장애(간헐성 파행증(이따금 절뚝거림))의 치료<br />
